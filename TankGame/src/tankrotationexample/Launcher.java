...
public class Launcher {
     ...
     */
    private String selectedLevel = "level3"; // default
    ...
    private void initUIComponents() {
        ...
        this.gamePanel.InitializeGame(this.selectedLevel); // initialize game, but DO NOT start game
        /*
        ...
        this.jf.addKeyListener(new java.awt.event.KeyAdapter() {
            @Override public void keyPressed(java.awt.event.KeyEvent e) {
                //System.out.println("JFRAME KEY: " + e.getKeyCode());
            }
        });

        this.jf.setResizable(true); //make the JFrame not resizable
    ...
    public void startGame(String level) {
        System.out.println("Launcher.startGame level = [" + level + "]");

        gamePanel.requestLoadLevel(level);
        setFrame("game");
    ...
    public void setFrame(String type) {
        // hide while changing cards/sizing (prevents weird focus issues)
        jf.pack();
